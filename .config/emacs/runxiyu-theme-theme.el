...
(deftheme runxiyu-theme)

(defcustom runxiyu-theme-box-org-todo t
  "Set box around TODO items in org-mode"
  :type 'boolean
  :group 'dark-plus)

(defcustom runxiyu-theme-scale-org-faces t
  "Scale headlines and other org faces"
  :type 'boolean
  :group 'dark-plus)

(defcustom runxiyu-theme-invert-hl-todo t
  "Set (:invert-video t) on hl-todo face"
  :type 'boolean
  :group 'dark-plus)

(defcustom runxiyu-theme-render-line-highlight 'default
...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(hl-line                                  ((,class ,(pcase runxiyu-theme-render-line-highlight
                                                          ((or 'line 'all)
   ...
   `(line-number-current-line                 ((,class (:inherit default :foreground ,line-num-current
                                                                 ,@(pcase runxiyu-theme-render-line-highlight
                                                                     ((or 'gutter 'all)
                                                                      `(:background ,bg1 :box (:color ,bg3 :line-width (0 . -1))))
                                                                     ((or 'none 'default)
                                                                      `(:background ,bg1)))))))
   ...
   `(org-level-1                              ((,class (:bold nil :foreground ,ms-bluegreen
                                                              ,@(when runxiyu-theme-scale-org-faces (list :height 1.1))))))
   ...
   `(org-todo                                 ((,class (,@(when runxiyu-theme-box-org-todo (list :box '(:line-width 1 :color ,ms-lightred)))
   ...
   `(org-agenda-date                          ((,class (:foreground ,var ,@(when runxiyu-theme-scale-org-faces (list :height 1.1))))))
   `(org-agenda-date-weekend                  ((,class (:weight normal :foreground ,fg4))))
   `(org-agenda-date-today                    ((,class (:weight normal :foreground ,keyword
                                                                ,@(when runxiyu-theme-scale-org-faces (list :height 1.2))))))
   ...
   `(org-document-title                       ((,class (:foreground ,type :bold t
                                                                    ,@(when runxiyu-theme-scale-org-faces (list :height 1.2)))))) ; title
   ...
   `(hl-todo                                  ((t ,@(when runxiyu-theme-invert-hl-todo (list :inverse-video t)))))
   ...
   `(highlight-thing                          ((t ,(pcase runxiyu-theme-render-line-highlight
...
(provide-theme 'runxiyu-theme)
(provide 'runxiyu-theme-theme)

;;; runxiyu-theme-theme.el ends here
