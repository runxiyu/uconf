...
# Modified for YK Pao School application registrations by Runxi Yu.
#
...
ENCRYPTION_PIPE = ["cat"]
DECRYPTION_PIPE = ["cat"]
# I personally don't see the point of encrypting this token which is in my home
# directory anyway, so I'll just use cat for the pipes. Feel free to change
# them back into something more sensible.
